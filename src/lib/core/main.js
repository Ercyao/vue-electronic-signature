...
import EventEx from '../class/event.js'
import Line from '../class/line.js'
import Point from '../class/point.js'
import ImageLoad from '../class/image.js'
import penCall from '../untils/penCall.js'
import penUrl from '../untils/penUrl.js'
...
merge(obj.prototype, {
  ...
  init() {
    ...
    this.addPen(
      ...
      penCall.writing.start,
      penCall.writing.move,
      penCall.writing.end
    )
  },
  moutedEle(e) {
  ...
  destory() {
    ...
    proxyCall(this, 'destoryKey', null, null, 1, () => {
      return true
    })
  },
  undo() {
  ...
  toPng() {
    this.option.bgColor = 'rgba(255, 255, 255, 0)'
    this.draw.draw()
